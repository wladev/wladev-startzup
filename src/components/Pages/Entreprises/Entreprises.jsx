        ...
        <div className="row">
            ...
            <div className="row mt-5">
                <div className="col mx-lg-5">
                    <p className="fs-4"><span className="text-uppercase fs-2" style={{'color': '#36E2AD'}}>Start-Zup agency</span> <br /> est le pôle professionnel de Start-Zup, le lien entre vos ambitions et nos teams.
