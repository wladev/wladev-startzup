...
import clickFinger from "../../../../assets/img/clickFinger.png";
...
export default function Parcours() {
    ...
    return (
        <>
            <div className="container-fluid" id="parcours">
                <div className="row">
                ...
                <div className="row d-flex justify-content-center">
                    <div className="col-lg-5">
                        <img
                            src={imgFrComp}
                            className="img-fluid"
                            alt="logo France Compétances"
                        />
                    </div>
                    <div className="col-lg-4 my-auto" style={{'fontWeight': 'bold'}}>
                        <p>RNCP37674 Développeur web et web mobile</p>
                        <p>RNCP37873 Concepteur développeur d'applications</p>
                    </div>
                </div>
                <div className="row my-5 d-flex justify-content-center">
                    <div className="col-8 ">
                        <h2
                            className="text-uppercase fs-2 p-3 rounded" /* style={{'backgroundColor': '#7ae4c479', 'color': 'white',}} */
                        >
                            De l'entrée en formation au recrutement
                        </h2>
                    </div>
                </div>
                ...
                <div className="row formations px-3 px-lg-0">
                    ...
                    >
                        <div class="card p-2" id="commun">
                            <div class=" ">
                                <div class=" rounded justify-center border-bottom border-4">
                                    <p
                                        className=""
                                        style={{
                                            fontSize: "4em",
                                ...
                                <div className="mt-2">
                                    <img src={clickFinger} alt="" width={50}/>
                                </div>
                                <div class="">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Acquérez des bases solides en
                                            Informatique et en Développement Web
                    ...
                    >
                        <div class="card p-2" id="specialisation">
                            <div class=" ">
                                <div class=" rounded-start justify-center border-bottom border-4">
                                    <p
                                        className=""
                                        style={{
                                            fontSize: "4em",
                                ...
                                <div class="">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Selon vos préférences ou vos
                                            objectifs, approfondissez vos
                                            connaissances parmi les
    ...
    function ModalCommun(props) {
        return (
            <Modal {...props} size="lg" centered id="modal_commun">
                <Modal.Header
                    closeButton
                ...
                <Modal.Body className="text-center fs-4">
                    <h4
                        className="text-center text-uppercase rounded"
                        style={{
                            backgroundColor: "#faa8ca",
                            color: "white",
                            paddingTop: "2vh",
                            paddingBottom: "2vh",
                        }}
                    ...
                    <hr className="mb-5" />
                    <h6
                        className="mb-5 text-uppercase text-center"
                        style={{ color: "#faa8ca" }}
                    >
        ...
        return (
            <Modal {...props} size="lg" centered id="modal_commun">
                ...
                <Modal.Body className="text-center fs-4">
                    ...
                    <hr className="mb-5" />
                    <h6
                        className="mb-5 fs-4 text-uppercase text-center"
                        style={{ color: "#7bd134" }}
                    >
                        Pourquoi et comment&nbsp;?
                    </h6>
                    <p className="fs-4">
                        Intégrer ou réintégrer le monde de l'entreprise est une
                        étape importante.
                        <br /> Start-Zup continue de vous accompagner.
                    </p>
